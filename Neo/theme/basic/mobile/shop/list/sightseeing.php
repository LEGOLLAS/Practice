...
<div class="container" style="padding-left: 10px; padding-right: 10px;">
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active" style="background-image: url('/Neo/theme/basic/img/mobile/slider_img4.JPG'); background-size: 100% 100%; background-repeat:no-repeat"></div>
      <div class="item" style="background-image: url('/Neo/theme/basic/img/mobile/slider_img5.jpg'); background-size: 100% 100%; background-repeat:no-repeat; "></div>
      <div class="item" style="background-image: url('/Neo/theme/basic/img/mobile/slider_img6.jpg'); background-size: 100% 100%; background-repeat:no-repeat; "></div>
    </div>
